...
public class Finder{
	...
	PrintWriter out;
	public Finder(String output) throws FileNotFoundException
	{
	...
	public boolean findText(String textToFind, String filePath) throws IOException
	{
		File f = new File(filePath);
	...
	public boolean findText(String textToFind, File f) throws IOException
	{
		//File f  = new File(filePath);
		if(f.isDirectory())
		{
