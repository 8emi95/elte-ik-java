...
public class IntegerMatrix {
	...
	public String toString(){
		// return toString1();   // BAJ: Nehezen olvasható, ráadásul a feltétel-kiértékelések nem hatékonyak, az értékadás gyorsabb.

		// return toString2(); // BAJ: a String immutable, minden konkatenációkor új példány készül, ráadásul mindig be kell járni. O(n^3)
